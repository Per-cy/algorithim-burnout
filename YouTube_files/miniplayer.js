(function(g){var window=this;'use strict';var qhb=function(a,b){g.V.call(this,{G:"button",Ja:["ytp-miniplayer-expand-watch-page-button","ytp-button","ytp-miniplayer-button-top-left"],X:{title:"{{title}}","data-tooltip-target-id":"ytp-miniplayer-expand-watch-page-button","aria-keyshortcuts":"i","data-title-no-tooltip":"{{data-title-no-tooltip}}"},W:[{G:"svg",X:{height:"24px",version:"1.1",viewBox:"0 0 24 24",width:"24px"},W:[{G:"g",X:{fill:"none","fill-rule":"evenodd",stroke:"none","stroke-width":"1"},W:[{G:"g",X:{transform:"translate(12.000000, 12.000000) scale(-1, 1) translate(-12.000000, -12.000000) "},
W:[{G:"path",X:{d:"M19,19 L5,19 L5,5 L12,5 L12,3 L5,3 C3.89,3 3,3.9 3,5 L3,19 C3,20.1 3.89,21 5,21 L19,21 C20.1,21 21,20.1 21,19 L21,12 L19,12 L19,19 Z M14,3 L14,5 L17.59,5 L7.76,14.83 L9.17,16.24 L19,6.41 L19,10 L21,10 L21,3 L14,3 Z",fill:"#fff","fill-rule":"nonzero"}}]}]}]}]});this.F=a;this.Sa("click",this.onClick,this);this.updateValue("title",g.QT(a,"Expand","i"));this.update({"data-title-no-tooltip":"Expand"});g.lb(this,g.KS(b.Jc(),this.element))},rhb=function(a){g.V.call(this,{G:"div",
N:"ytp-miniplayer-ui"});this.dg=!1;this.player=a;this.S(a,"minimized",this.Vh);this.S(a,"onStateChange",this.zP)},shb=function(a){g.tT.call(this,a);
this.u=new g.XH(this);this.j=new rhb(this.player);this.j.hide();g.yS(this.player,this.j.element,4);a.Ag()&&(this.load(),g.Sp(a.getRootNode(),"ytp-player-minimized",!0))};
g.x(qhb,g.V);qhb.prototype.onClick=function(){this.F.Oa("onExpandMiniplayer")};g.x(rhb,g.V);g.k=rhb.prototype;
...
g.k.d7=function(){this.player.playVideo()};
...
g.k.VA=function(){};
g.k.Yr=function(){};
g.k.DD=function(){};g.x(shb,g.tT);g.k=shb.prototype;g.k.onVideoDataChange=function(){if(this.player.getVideoData()){var a=this.player.getVideoAspectRatio(),b=16/9;a=a>b+.1||a<b-.1;g.Sp(this.player.getRootNode(),"ytp-rounded-miniplayer-not-regular-wide-video",a)}};
...
g.k.unload=function(){this.player.showControls();this.j.hide()};g.sT("miniplayer",shb);})(_yt_player);
